...
const uri = `mongodb+srv://${process.env.USER}:${process.env.PASS}@cluster0.xhirfgb.mongodb.net/?retryWrites=true&w=majority`;
...
app.get('/', (req, res) => {
  res.send('mmanagement is sitting')
})

app.listen(port, () => {
  console.log(`mmanagement is sitting on port ${port}`);
})
